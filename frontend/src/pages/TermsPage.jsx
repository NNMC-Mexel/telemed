                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 sm:p-10">
                    ...
                    <Section title="6. Ответственность платформы">
                        <p>
                            ...
                            предоставляются врачами Медицинской организации и являются зоной
                            профессиональной ответственности врача и Медицинской организации.
                        </p>
                        <p>
                            Платформа является техническим инструментом для дистанционного
                            взаимодействия и не заменяет очного приёма у специалиста, если врач
                            определил необходимость очного осмотра.
                        </p>
                    </Section>
